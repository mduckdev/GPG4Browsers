...
export default function PassphraseTextInput({value,setOnChange}:PassphraseTextInputProps) {
    ...
    return (
        ...
        <div className="relative">
          <input id="hs-toggle-password" type={showPassword?"text":"password"} className="w-full border border-gray-300 dark:border-gray-500 focus:outline-none focus:border-blue-500 rounded-md py-2 px-4" placeholder="Enter password" />
